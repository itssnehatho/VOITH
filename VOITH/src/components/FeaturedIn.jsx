const FeaturedIn = () => {
  ...
  return (
    <section className="w-full bg-[#FFFBF5] py-2 sm:py-2.5 md:py-3 border-b border-gray-200">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        <div className="flex items-center justify-between flex-wrap gap-2 sm:gap-2.5 md:gap-3"> 
          <h2 className="text-[8px] sm:text-[9px] md:text-[10px] font-light tracking-[0.25em] uppercase" style={{ color: '#3E454D' }}>  
            • FEATURED IN 
          </h2>
          <div
