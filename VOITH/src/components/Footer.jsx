const Footer = () => {
  return (
    <footer className="w-full bg-white text-black py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8 md:gap-10 lg:gap-12 mb-6 sm:mb-8 items-start">
          <div>
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              ...
              <li><a href="#gallery" className="text-sm sm:text-base text-gray-600 hover:text-gray-900 transition-colors">GALLARY</a></li>
          ...
          <div>
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              ...
              <li><a href="#" className="text-sm sm:text-base text-gray-600 hover:text-gray-900 transition-colors">LINKED IN</a></li>
            </ul>
          </div>

          <div className="sm:col-span-2 md:col-span-2">
            <h3 className="text-xs sm:text-sm font-semibold mb-3 sm:mb-4 tracking-[0.1em] uppercase">GENERAL INQUIRES</h3>
