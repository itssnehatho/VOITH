      ...
      >
        <div className="sticky top-0 h-screen flex flex-col justify-center px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 pointer-events-auto">
          ...
          <div className="space-y-6 sm:space-y-7 md:space-y-8">
            <p className="font-['Times_New_Roman',serif] text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-900 leading-[1.4] tracking-[-0.02em] font-light">
              <AnimatedText 
            ...
            <p className="font-sans text-sm sm:text-base md:text-lg text-gray-600 leading-[1.85] font-light">
              <AnimatedText 
            ...
            <div className="pt-4 border-t border-gray-200">
              <p className="font-sans text-sm sm:text-base md:text-lg text-gray-700 leading-[1.85] mb-6 font-light">
                <AnimatedText 
            ...
            <p className="font-['Times_New_Roman',serif] text-lg sm:text-xl md:text-2xl text-gray-900 leading-[1.4] tracking-[-0.02em] font-light">
              <AnimatedText 
