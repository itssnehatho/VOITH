  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      const ctx = gsap.context(() => {
        ...
        if (textPanelRef.current) gsap.set(textPanelRef.current, { opacity: 0, x: -30 });
        ...
        ScrollTrigger.create({
          ...
          onUpdate: (self) => {
            ...
            if (progress <= slidePhaseEnd) {
              ...
              gsap.set(imageContainerRef.current, { width: `${width}%` });
              ...
              if (textPanelRef.current) gsap.set(textPanelRef.current, { opacity: 1, x: 0 });
            }
