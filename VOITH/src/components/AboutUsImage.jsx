    ...
    const timer = setTimeout(() => {
      ...
      const ctx = gsap.context(() => {
        ...
        ScrollTrigger.create({
          ...
          snap: {
            snapTo: (value) => {
              // No snapping during the initial "slide-in" phase
          ...
          onUpdate: (self) => {
            ...
            if (progress <= slidePhaseEnd) {
              ...
              // Image slides from full width to 50%
            ...
            if (progress > slidePhaseEnd) {
              ...
              // DeGraw & DeHaan style: vertical slider (scroll down -> images move UP)
              if (trackRef.current) {
  ...
  return (
    <section ref={sectionRef} className="w-full relative">
      ...
      <div ref={wrapperRef} className="hidden md:block relative w-full h-screen overflow-hidden">
        ...
        <div
          ref={textPanelRef}
          className="absolute left-0 top-0 w-1/2 h-full p-8 sm:p-10 md:p-12 lg:p-16 flex flex-col justify-between bg-[#FFF9F0] z-10"
          style={{ opacity: 0 }}
        >
          <div>
            {/* Featured Company Label */}
