      ...
      <div className="max-w-7xl mx-auto px-8 md:px-12 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20 items-center">
          <div className={`order-2 lg:order-1 transition-all duration-[1800ms] ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-6'}`}>
            <div className="relative w-full h-[450px] md:h-[550px] lg:h-[650px] overflow-hidden group">
              ...
              <button
                ...
                className="absolute left-4 md:left-6 top-1/2 -translate-y-1/2 z-20 bg-white/90 hover:bg-white text-gray-800 p-2 md:p-3 rounded-full transition-all duration-300 hover:scale-110 shadow-lg"
              ...
              <button
                onClick={goToNext}
                className="absolute right-4 md:right-6 top-1/2 -translate-y-1/2 z-20 bg-white/90 hover:bg-white text-gray-800 p-2 md:p-3 rounded-full transition-all duration-300 hover:scale-110 shadow-lg"
          ...
          <div className={`order-1 lg:order-2 transition-all duration-[1800ms] ease-out delay-[200ms] ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-6'}`}> 
            <h2 className={`text-xs md:text-sm font-light text-gray-500 mb-10 tracking-[0.2em] uppercase transition-all duration-[1500ms] ease-out delay-[300ms] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              {ABOUT_US_CONTENT.title}
            </h2>
            <p className={`text-base md:text-lg lg:text-xl text-gray-700 leading-[1.85] mb-12 tracking-[-0.01em] font-light transition-all duration-[1500ms] ease-out delay-[400ms] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <a
              ...
              className={`group inline-block px-12 py-5 bg-gray-900 text-white font-light text-sm uppercase tracking-[0.15em] hover:bg-gray-800 transition-all duration-500 ease-out hover:shadow-xl relative overflow-hidden ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
