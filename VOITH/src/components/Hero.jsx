    ...
    <section ref={sectionRef} className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-start text-left max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 pt-16 sm:pt-20 md:pt-24 lg:pt-32 xl:pt-40">
        <div className="max-w-4xl lg:max-w-5xl relative w-full">
          ...
          {/* Body  */}
          <p className={`text-sm sm:text-base md:text-lg lg:text-xl text-white/95 max-w-3xl lg:max-w-4xl leading-[1.75] sm:leading-[1.85] font-light tracking-[-0.01em] text-justify transition-all duration-[1800ms] ease-out delay-[300ms] mb-8 sm:mb-10 md:mb-12 lg:mb-14 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
