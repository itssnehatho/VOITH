    ...
    <div className="min-h-screen bg-white relative">
      <div className={`relative transition-all duration-[2000ms] ease-out ${pageLoaded ? 'translate-y-0 opacity-100' : 'opacity-0'}`}>
        ...
        <section className="relative w-full h-[600px] md:h-[700px] lg:h-[900px] overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16 pt-24 sm:pt-28 md:pt-32 max-w-[1440px] mx-auto">
        ...
        <section className="w-full bg-white py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 border-t border-gray-100">
          <div className="max-w-[1440px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
            <h2 className="font-['Times_New_Roman',serif] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light text-gray-900 mb-12 sm:mb-16 md:mb-20 text-center tracking-[-0.02em] uppercase">
              EXPLORE PROJECTS
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20">
              {["/homepage.jpg", "/home2.png"].map((src, idx) => (
                <div key={idx} className="group cursor-pointer">
                  <div className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] xl:h-[500px] overflow-hidden mb-4 sm:mb-6">
                  ...
                  <p className="font-['Times_New_Roman',serif] text-lg sm:text-xl md:text-2xl font-light text-gray-900 tracking-[-0.01em] group-hover:text-gray-700 transition-colors duration-300 text-center uppercase">
                    VIEW {idx === 0 ? "RESIDENTIAL PROJECTS" : "PROJECTS"}
                  </p>
                </div>
              ))}
            </div>
