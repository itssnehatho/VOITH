              ...
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 lg:gap-20 items-center transition-opacity duration-[1500ms] ease-out delay-[200ms] ${
                ...
                <div>
                  <div className="flex flex-wrap items-center gap-6 sm:gap-8">
                    ...
                    <a href="https://www.linkedin.com/company/vaidya-s-organisation-of-industries-and-trading-houses-voith/about/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full border-2 border-red-600 text-red-600 bg-transparent hover:bg-red-600 hover:text-white transition-colors" aria-label="LinkedIn">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
