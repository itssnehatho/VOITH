  ...
  return (
    <div className="page-root min-h-screen bg-[#FFFBF5] relative overflow-anchor-none">
      <div className="relative overflow-anchor-none">
          ...
          <div className="relative z-10 flex-1 flex flex-col justify-end pt-32 sm:pt-40 lg:pt-48 pb-14 sm:pb-16 md:pb-20 lg:pb-24 xl:pb-28 max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 w-full">
            <div className={`mb-6 transition-all duration-[1800ms] ease-out delay-[200ms] ${
              ...
              <span className="text-xs sm:text-sm font-light text-white/80 tracking-[0.3em] uppercase">
                <span className="text-[#E85244]">•</span> CONTACT
              </span>
            </div>
        ...
        <section
          ref={contactRef}
          className="w-full py-16 sm:py-20 md:py-24 lg:py-28 bg-[#FFFBF5]"
        >
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
            <div className="space-y-12 sm:space-y-14 md:space-y-16 lg:space-y-20">
              ...
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 lg:gap-20 items-start transition-opacity duration-[1500ms] ease-out ${
                ...
                <div>
                  <h2 className="text-xs sm:text-xs md:text-sm font-light text-gray-500 mb-8 tracking-[0.2em] uppercase">
                    <span className="text-[#E85244]">•</span> GENERAL INQUIRIES
                  </h2>
                ...
                <div className="group">
                  <p className="text-base sm:text-lg md:text-xl text-gray-900 mb-4 sm:mb-5 font-light">
                    <a 
                      ...
                      className="hover:text-[#E85244] transition-colors duration-300 border-b border-transparent hover:border-[#E85244] pb-1"
                    >
                      info@voith.com.np
                    </a>
                  </p>
              ...
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 lg:gap-20 items-center transition-opacity duration-[1500ms] ease-out delay-[200ms] ${
                ...
                <div>
                  <h2 className="text-xs sm:text-xs md:text-sm font-light text-gray-500 tracking-[0.2em] uppercase">
                    <span className="text-[#E85244]">•</span> SOCIAL LINKS
                  </h2>
                  <div className="h-px w-16 bg-gray-300 mt-8"></div>
                </div>
                <div>
                  <div className="flex flex-wrap items-center gap-6 sm:gap-8">
                    <a href="#" className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full border-2 border-[#E85244] text-[#E85244] bg-transparent hover:bg-[#E85244] hover:text-white transition-colors duration-100" aria-label="Facebook">
                    ...
                    <a href="#" className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full border-2 border-[#E85244] text-[#E85244] bg-transparent hover:bg-[#E85244] hover:text-white transition-colors duration-100" aria-label="Instagram">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                    ...
                    <a href="#" className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full border-2 border-[#E85244] text-[#E85244] bg-transparent hover:bg-[#E85244] hover:text-white transition-colors duration-100" aria-label="TikTok">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                    ...
                    <a href="https://www.linkedin.com/company/vaidya-s-organisation-of-industries-and-trading-houses-voith/about/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full border-2 border-[#E85244] text-[#E85244] bg-transparent hover:bg-[#E85244] hover:text-white transition-colors duration-100" aria-label="LinkedIn">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 lg:gap-20 items-start transition-opacity duration-[1500ms] ease-out delay-[400ms] ${
                ...
                <div>
                  <h2 className="text-xs sm:text-xs md:text-sm font-light text-gray-500 tracking-[0.2em] uppercase">
                    <span className="text-[#E85244]">•</span> CAREER OPPORTUNITIES
                  </h2>
                  <div className="h-px w-16 bg-gray-300 mt-8"></div>
                </div>
                <div>
                  ...
                  <p>
                    <a 
                      ...
                      className="text-sm sm:text-base md:text-lg text-gray-900 hover:text-[#E85244] transition-colors duration-300 border-b border-transparent hover:border-[#E85244] pb-1"
                    >
        ...
        <section
          ref={formRef}
          className={`w-full py-16 sm:py-20 md:py-24 lg:py-32 bg-[#FFFBF5] transition-opacity duration-[1500ms] ease-out ${
            contactVisible ? 'opacity-100' : 'opacity-0'
          }`}
        >
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <div className="flex items-center justify-center gap-2">
                <div className="h-px w-12 bg-[#E85244]"></div>
                <div className="h-1 w-1 rounded-full bg-[#E85244]"></div>
                <div className="h-px w-12 bg-[#E85244]"></div>
              </div>
            </div>
            ...
            <form className="max-w-2xl mx-auto space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="group">
                  <label 
                    className="block text-sm font-light text-gray-700 mb-2 transition-colors duration-300 group-focus-within:text-[#E85244]" 
                    htmlFor="name"
                  >
                    Name *
                  </label>
                  <input
                    ...
                    name="name"
                    required
                    className="w-full border border-gray-300 rounded-sm px-4 py-3 text-base text-gray-900 font-light bg-white focus:border-[#E85244] focus:ring-1 focus:ring-[#E85244] focus:outline-none transition-all duration-300 placeholder:text-gray-400"
              ...
              <div className="group">
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full border border-gray-300 rounded-sm px-4 py-3 text-base text-gray-900 font-light bg-white focus:border-[#E85244] focus:ring-1 focus:ring-[#E85244] focus:outline-none transition-all duration-300 resize-none placeholder:text-gray-400"
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="group w-full md:w-auto px-10 py-4 bg-transparent border border-gray-900 text-gray-900 text-sm font-light tracking-[0.1em] uppercase rounded-full transition-colors duration-100 hover:bg-[#E85244] hover:border-[#E85244] hover:text-white hover:shadow-lg hover:shadow-[#E85244]/20 flex items-center justify-center gap-3"
                >
